...
jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function(j, i, p, o, n) {
        ...
        if (i < 1) {
            return -0.5 * k * Math.pow(2, 10 * (i -= 1)) * Math.sin((i * n - m) * 2 * Math.PI / l) + p
        }
        return k * Math.pow(2, -10 * (i -= 1)) * Math.sin((i * n - m) * 2 * Math.PI / l) * 0.5 + o + p
    },
    ...
    easeInOutBounce: function(g, f, j, i, h) {
        ...
        return jQuery.easing.easeOutBounce(g, f * 2 - h, 0, i, h) * 0.5 + i * 0.5 + j
    }
});
/*!
...
! function() {
    ...
    function aJ() {
        if (!ab && document.body) {
            ...
            var f = document.body,
                ...
                g = f.scrollHeight;
            if (aA = document.compatMode.indexOf("CSS") >= 0 ? h : f, ax = f, a1(), top != self) {
                al = !0
            } else {
                if (aB && g > k && (f.offsetHeight <= k || h.offsetHeight <= k)) {
                    var d = document.createElement("div");
                    d.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + aA.scrollHeight + "px", document.body.appendChild(d);
                    var e;
                    ag = function() {
                        e || (e = setTimeout(function() {
                            ao || (d.style.height = "0", d.style.height = aA.scrollHeight + "px", e = null)
                        }, 500))
                    }, setTimeout(ag, 10), aR("resize", ag);
                    var b = {
                        attributes: !0,
                        childList: !0,
                        characterData: !1
            ...
            aD.fixedBackground || ao || (f.style.backgroundAttachment = "scroll", h.style.backgroundAttachment = "scroll")
        }
    }

    function aP() {
        an && an.disconnect(), aG(a6, aL), aG("mousedown", aW), aG("keydown", a5), aG("resize", ag), aG("load", aJ)
    }
                ...
                b = function() {
                    for (var i = Date.now(), e = 0, t = 0, q = 0; q < ai.length; q++) {
                        ...
                        var l = x.x * o - x.lastX >> 0,
                            v = x.y * o - x.lastY >> 0;
                        e += l, t += v, x.lastX += l, x.lastY += v, y && (ai.splice(q, 1), q--)
                    }
                    d ? window.scrollBy(e, t) : (e && (h.scrollLeft += e), t && (h.scrollTop += t)), f || j || (ai = []), ai.length ? ad(b, h, 1000 / aD.frameRate + 1) : aV = !1
                };
            ad(b, h, 0), aV = !0
        }
    }
    ...
    function aL(f) {
        ...
        if (aX(ax, "embed") || aX(g, "embed") && /\.pdf/i.test(g.src) || aX(ax, "object") || g.shadowRoot) {
            return !0
        }
        var d = -f.wheelDeltaX || f.deltaX || 0,
            b = -f.wheelDeltaY || f.deltaY || 0;
        am && (f.wheelDeltaX && aE(f.wheelDeltaX, 120) && (d = -120 * (f.wheelDeltaX / Math.abs(f.wheelDeltaX))), f.wheelDeltaY && aE(f.wheelDeltaY, 120) && (b = -120 * (f.wheelDeltaY / Math.abs(f.wheelDeltaY)))), d || b || (b = -f.wheelDelta || 0), 1 === f.deltaMode && (d *= 40, b *= 40);
        var c = aI(g);
        return c ? aH(b) ? !0 : (Math.abs(d) > 1.2 && (d *= aD.stepSize / 120), Math.abs(b) > 1.2 && (b *= aD.stepSize / 120), aQ(c, d, b), f.preventDefault(), void aS()) : al && aj ? (Object.defineProperty(f, "target", {
    ...
    function a5(l) {
        var v = l.target,
            g = l.ctrlKey || l.altKey || l.metaKey || l.shiftKey && l.keyCode !== ap.spacebar;
        ...
        if (l.defaultPrevented || b.test(v.nodeName) || aX(v, "input") && !q.test(v.type) || aX(ax, "video") || aY(l) || v.isContentEditable || g) {
            return !0
        }
        if ((aX(v, "button") || aX(v, "input") && q.test(v.type)) && l.keyCode === ap.spacebar) {
            return !0
        }
    ...
    function aS() {
        clearTimeout(aw), aw = setInterval(function() {
            av = {}
        }, 1000)
    }
    ...
    function aO(b, a) {
        b = b > 0 ? 1 : -1, a = a > 0 ? 1 : -1, (ac.x !== b || ac.y !== a) && (ac.x = b, ac.y = a, ai = [], aM = 0)
    }

    function aH(a) {
        return a ? (az.length || (az = [a, a, a]), a = Math.abs(a), az.push(a), az.shift(), clearTimeout(ay), ay = setTimeout(function() {
            try {
                localStorage.SS_deltaBuffer = az.join(",")
            } catch (b) {}
        }, 1000), !a4(120) && !a4(100)) : void 0
    }
    ...
    function ah(b) {
        var a, c, d;
        return b *= aD.pulseScale, 1 > b ? a = b - (1 - Math.exp(-b)) : (c = Math.exp(-1), b -= 1, d = 1 - Math.exp(-b), a = c + d * (1 - c)), a * aD.pulseNormalize
    }

    function aF(a) {
        return a >= 1 ? 1 : 0 >= a ? 0 : (1 == aD.pulseNormalize && (aD.pulseNormalize /= ah(1)), ah(a))
    }
    ...
    var a6, ad = function() {
            return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(b, a, c) {
        ...
        aU = (aj || aa || aZ) && !aN;
    "onwheel" in document.createElement("div") ? a6 = "wheel" : "onmousewheel" in document.createElement("div") && (a6 = "mousewheel"), a6 && aU && (aR(a6, aL), aR("mousedown", aW), aR("load", aJ)), aT.destroy = aP, window.SmoothScrollOptions && aT(window.SmoothScrollOptions), "function" == typeof define && define.amd ? define(function() {
        return aT
    }) : "object" == typeof exports ? module.exports = aT : window.SmoothScroll = aT
}();
! function(a) {
    ...
    var h = -1,
        ...
        g = d.fn.matchHeight = function(l) {
            ...
            if (m.remove) {
                var i = this;
                return this.css(m.property, ""), d.each(g._groups, function(a, n) {
                    n.elements = n.elements.not(i)
                }), this
            }
            return this.length <= 1 && !m.target ? this : (g._groups.push({
                elements: this,
                options: m
            }), g._apply(this, m), this)
        };
    g.version = "master", g._groups = [], g._throttle = 80, g._maintainScroll = !1, g._beforeUpdate = null, g._afterUpdate = null, g._rows = c, g._parse = b, g._parseOptions = k, g._apply = function(q, t) {
        var m = k(t),
            i = d(q),
            a = [i],
        ...
        }), r.css("display", "block"), m.byRow && !m.target && (i.each(function() {
            var l = d(this),
                p = l.css("display");
            ...
            if (m.target) {
                ...
                l.each(function() {
                    var y = d(this),
                        z = y.attr("style"),
                        w = y.css("display");
                    "inline-block" !== w && "flex" !== w && "inline-flex" !== w && (w = "block");
                    var x = {
                        display: w
                    };
                    x[m.property] = "", y.css(x), y.outerHeight(!1) > v && (v = y.outerHeight(!1)), z ? y.attr("style", z) : y.css("display", "")
                })
            }
            l.each(function() {
                var w = d(this),
                    x = 0;
                m.target && w.is(m.target) || ("border-box" !== w.css("box-sizing") && (x += b(w.css("border-top-width")) + b(w.css("border-bottom-width")), x += b(w.css("padding-top")) + b(w.css("padding-bottom"))), w.css(m.property, v - x + "px"))
            })
        }), r.each(function() {
            var l = d(this);
    ...
    var f = function(a) {
        g._beforeUpdate && g._beforeUpdate(a, g._groups), d.each(g._groups, function() {
    ...
    g._update = function(e, l) {
        ...
        e ? -1 === j && (j = setTimeout(function() {
            f(l), j = -1
        }, g._throttle)) : f(l)
    }, d(g._applyDataApi), d(window).bind("load", function(a) {
        g._update(!1, a)
        ...
        a.data(D, "flexslider", j), x = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    var m = "thumbnails" === j.vars.controlNav ? "control-thumbs" : "control-paging",
                        f = 1,
                        d, i;
                    if (j.controlNavScaffold = a('<ol class="' + w + "control-nav " + w + m + '"></ol>'), j.pagingCount > 1) {
                        for (var l = 0; l < j.pagingCount; l++) {
                            if (i = j.slides.eq(l), void 0 === i.attr("data-thumb-alt") && i.attr("data-thumb-alt", ""), altText = "" !== i.attr("data-thumb-alt") ? altText = ' alt="' + i.attr("data-thumb-alt") + '"' : "", d = "thumbnails" === j.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + f + "</a>", "thumbnails" === j.vars.controlNav && !0 === j.vars.thumbCaptions) {
                                var n = i.attr("data-thumbcaption");
                                "" !== n && void 0 !== n && (d += '<span class="' + w + 'caption">' + n + "</span>")
                            }
                            j.controlNavScaffold.append("<li>" + d + "</li>"), f++
                        }
                    }
                    j.controlsContainer ? a(j.controlsContainer).append(j.controlNavScaffold) : j.append(j.controlNavScaffold), x.controlNav.set(), x.controlNav.active(), j.controlNavScaffold.delegate("a, img", h, function(p) {
                        if (p.preventDefault(), "" === q || q === p.type) {
                            var o = a(this),
                                c = j.controlNav.index(o);
                            o.hasClass(w + "active") || (j.direction = c > j.currentSlide ? "next" : "prev", j.flexAnimate(c, j.vars.pauseOnAction))
                        }
            ...
            touch: function() {
                ...
                function N(l) {
                    ...
                    if (c) {
                        var m = -l.translationX,
                            f = -l.translationY;
                        return t += y ? f : m, p = t, M = y ? Math.abs(t) < Math.abs(-m) : Math.abs(t) < Math.abs(-f), l.detail === l.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                            D._gesture.stop()
                        }) : void((!M || Number(new Date) - H > 500) && (l.preventDefault(), !g && c.transitions && (c.vars.animationLoop || (p = t / (0 === c.currentSlide && 0 > t || c.currentSlide === c.last && t > 0 ? Math.abs(t) / J + 2 : 1)), c.setProps(s + p, "setTouch"))))
                    }
                }
                ...
                E ? (D.style.msTouchAction = "none", D._gesture = new MSGesture, D._gesture.target = D, D.addEventListener("MSPointerDown", I, !1), D._slider = j, D.addEventListener("MSGestureChange", N, !1), D.addEventListener("MSGestureEnd", v, !1)) : (G = function(c) {
                    j.animating ? c.preventDefault() : (window.navigator.msPointerEnabled || 1 === c.touches.length) && (j.pause(), J = y ? j.h : j.w, H = Number(new Date), L = c.touches[0].pageX, K = c.touches[0].pageY, s = B && C && j.animatingTo === j.last ? 0 : B && C ? j.limit - (j.itemW + j.vars.itemMargin) * j.move * j.animatingTo : B && j.currentSlide === j.last ? j.limit : B ? (j.itemW + j.vars.itemMargin) * j.move * j.currentSlide : C ? (j.last - j.currentSlide + j.cloneOffset) * J : (j.currentSlide + j.cloneOffset) * J, d = y ? K : L, n = y ? L : K, D.addEventListener("touchmove", F, !1), D.addEventListener("touchend", u, !1))
                }, F = function(f) {
                    L = f.touches[0].pageX, K = f.touches[0].pageY, p = y ? d - K : d - L, M = y ? Math.abs(p) < Math.abs(L - n) : Math.abs(p) < Math.abs(K - n);
                    var c = 500;
                    (!M || Number(new Date) - H > c) && (f.preventDefault(), !g && j.transitions && (j.vars.animationLoop || (p /= 0 === j.currentSlide && 0 > p || j.currentSlide === j.last && p > 0 ? Math.abs(p) / J + 2 : 1), j.setProps(s + p, "setTouch")))
                }, u = function(l) {
                    if (D.removeEventListener("touchmove", F, !1), j.animatingTo === j.currentSlide && !M && null !== p) {
                        var c = C ? -p : p,
            ...
            smoothHeight: function(d) {
                if (!y || g) {
                    ...
                    }, d) : c.height(j.slides.eq(j.animatingTo).height())
                }
            },
            sync: function(f) {
        ...
        if (void 0 === d && (d = {}), "object" == typeof d) {
            return this.each(function() {
                var f = a(this),
                    ...
                    g = f.find(e);
                1 === g.length && d.allowOneSlide === !0 || 0 === g.length ? (g.fadeIn(400), d.start && d.start(f)) : void 0 === f.data("flexslider") && new a.flexslider(this, d)
            })
        }
...
(function() {
    ...
    h = function() {
        ...
        return b.prototype.extend = function(f, e) {
            ...
            var o;
            return null == f && (f = !1), null == q && (q = !1), null == p && (p = null), null != document.createEvent ? (o = document.createEvent("CustomEvent"), o.initCustomEvent(g, f, q, p)) : null != document.createEventObject ? (o = document.createEventObject(), o.eventType = g) : o.eventName = g, o
        }, b.prototype.emitEvent = function(d, c) {
            return null != d.dispatchEvent ? d.dispatchEvent(c) : c in (null != d) ? d[c]() : "on" + c in (null != d) ? d["on" + c]() : void 0
        ...
        return a.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function() {
                    var b, s, r, q;
                    for (r = this.element.querySelectorAll("." + this.config.boxClass), q = [], b = 0, s = r.length; s > b; b++) {
                        f = r[b], q.push(f)
                    }
                    return q
            ...
            return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new i(function(b) {
                return function(q) {
                    var v, u, t, s, r;
                    for (r = [], v = 0, u = q.length; u > v; v++) {
                        s = q[v], r.push(function() {
                            var w, e, y, x;
                            for (y = s.addedNodes || [], x = [], w = 0, e = y.length; e > w; w++) {
            ...
            if (null == o && (o = this.element), 1 === o.nodeType) {
                for (o = o.parentNode || o, q = o.querySelectorAll("." + this.config.boxClass), p = [], s = 0, r = q.length; r > s; s++) {
                    g = q[s], j.call(this.all, g) < 0 ? (this.boxes.push(g), this.all.push(g), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(g, !0), p.push(this.scrolled = !0)) : p.push(void 0)
                }
                return p
            }
            ...
            var q, p, o;
            return p = g.getAttribute("data-wow-duration"), q = g.getAttribute("data-wow-delay"), o = g.getAttribute("data-wow-iteration"), this.animate(function(b) {
                return function() {
            ...
            var c;
            return d.type.toLowerCase().indexOf("animationend") >= 0 ? (c = d.target || d.srcElement, c.className = c.className.replace(this.config.animateClass, "").trim()) : void 0
        }, a.prototype.customStyle = function(g, f, q, p, o) {
            return f && this.cacheAnimationName(g), g.style.visibility = f ? "hidden" : "visible", q && this.vendorSet(g.style, {
                animationDuration: q
            ...
            r = [];
            for (s in g) {
                q = g[s], o["" + s] = q, r.push(function() {
                    var c, t, f, e;
                    for (f = this.vendors, e = [], c = 0, t = f.length; t > c; c++) {
                        p = f[c], e.push(o["" + p + s.charAt(0).toUpperCase() + s.substr(1)] = q)
                    }
                    return e
                }.call(this))
            }
            ...
            var u, t, s, r, q, p;
            for (q = m(o), r = q.getPropertyCSSValue(d), s = this.vendors, u = 0, t = s.length; t > u; u++) {
            ...
            var g, s, r, q, p;
            return s = o.getAttribute("data-wow-offset") || this.config.offset, p = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset, q = p + Math.min(this.element.clientHeight, this.util().innerHeight()) - s, r = this.offsetTop(o), g = r + o.clientHeight, q >= r && g >= p
...
! function(a, b) {
    ...
    function a(k, m, e) {
        function l(i, q, u) {
            var s, p = "$()." + k + '("' + q + '")';
            return i.each(function(o, r) {
                var n = e.data(r, k);
                if (!n) {
                    return void c(k + " not initialized. Cannot call methods, i.e. " + p)
                }
                var v = n[q];
                if (!v || "_" == q.charAt(0)) {
    ...
    var g = Array.prototype.slice,
        d = b.console,
        c = "undefined" == typeof d ? function() {} : function(e) {
            d.error(e)
        };
...
function(a, b) {
    ...
    function b(u) {
        if (c(), "string" == typeof u && (u = document.querySelector(u)), u && "object" == typeof u && u.nodeType) {
            ...
            for (var w = G.isBorderBox = "border-box" == h.boxSizing, B = 0; p > B; B++) {
                var o = j[B],
                    t = h[o],
                    n = parseFloat(t);
                G[o] = isNaN(n) ? 0 : n
    ...
    var v, m = "undefined" == typeof console ? k : function(a) {
            console.error(a)
        },
...
function(a, b) {
    ...
    a.extend = function(g, h) {
        ...
        var f = g.indexOf(h); - 1 != f && g.splice(f, 1)
    ...
    return a.htmlInit = function(f, g) {
        a.docReady(function() {
            ...
            i.forEach(function(q) {
                var p, u = q.getAttribute(k) || q.getAttribute(m);
                try {
                    p = u && JSON.parse(u)
                } catch (o) {
                    return void(d && d.error("Error parsing " + k + " on " + q.className + ": " + o))
                }
                var s = new f(q, p);
                n && n.data(q, g, s)
            })
...
function(a, b) {
    ...
    z.constructor = g, z._create = function() {
        this._transn = {
            ingProperties: {},
            clean: {},
            onEnd: {}
        ...
        var f = getComputedStyle(this.element),
            ...
            u = f[d ? "top" : "bottom"],
            l = this.layout.size,
            h = -1 != E.indexOf("%") ? parseFloat(E) / 100 * l.width : parseInt(E, 10),
            c = -1 != u.indexOf("%") ? parseFloat(u) / 100 * l.height : parseInt(u, 10);
        h = isNaN(h) ? 0 : h, c = isNaN(c) ? 0 : c, h -= m ? l.paddingLeft : l.paddingRight, c -= d ? l.paddingTop : l.paddingBottom, this.position.x = h, this.position.y = c
        ...
        G[K] = this.getYValue(I), G[H] = "", this.css(G), this.emitEvent("layout", [this])
        ...
        var F = H - l,
            m = E - f,
            G = {};
        G.transform = this.getTranslate(F, m), this.transition({
            to: G,
            onTransitionEnd: {
    ...
    }, z.moveTo = z._transitionTo, z.setPosition = function(a, c) {
    ...
    }, z.transition = g.prototype[A ? "_transition" : "_nonTransition"], z.onwebkitTransitionEnd = function(a) {
    ...
    z.ontransitionend = function(c) {
        if (c.target === this.element) {
            ...
            if (delete d.ingProperties[a], j(d.ingProperties) && this.disableTransition(), a in d.clean && (this.element.style[c.propertyName] = "", delete d.clean[a]), a in d.onEnd) {
                var f = d.onEnd[a];
    ...
    return z.removeTransitionStyles = function() {
        this.css(k)
...
function(a, b) {
    ...
    function b(c, h) {
        ...
        if (!a) {
            return void(w && w.error("Bad element for " + this.constructor.namespace + ": " + (a || c)))
        }
        this.element = a, m && (this.$element = m(this.element)), this.options = g.extend({}, this.constructor.defaults), this.option(h);
        var l = ++q;
    ...
    var w = y.console,
        ...
        q = 0,
        v = {};
    b.namespace = "outlayer", b.Item = f, b.defaults = {
        containerStyle: {
            position: "relative"
        },
        initLayout: !0,
    ...
    var j = b.prototype;
    return g.extend(j, p.prototype), j.option = function(a) {
        ...
        this.reloadItems(), this.stamps = [], this.stamp(this.options.stamp), g.extend(this.element.style, this.options.containerStyle);
        var a = this._getOption("resize");
        a && this.bindResize()
    }, j.reloadItems = function() {
        this.items = this._itemize(this.element.children)
    }, j._itemize = function(c) {
        for (var l = this._filterFindItemElements(c), a = this.constructor.Item, A = [], u = 0; u < l.length; u++) {
            var h = l[u],
                d = new a(h, this);
            A.push(d)
        }
    ...
    }, j._init = j.layout, j._resetLayout = function() {
        this.getSize()
    }, j.getSize = function() {
        this.size = k(this.element)
    }, j._getMeasurement = function(a, c) {
        var h, d = this.options[a];
        d ? ("string" == typeof d ? h = this.element.querySelector(d) : d instanceof HTMLElement && (h = d), this[a] = h ? k(h)[c] : d) : this[a] = 0
    ...
    }, j._getContainerSize = x, j._setContainerMeasure = function(c, d) {
        if (void 0 !== c) {
            var a = this.size;
        ...
        return a ? ("string" == typeof a && (a = this.element.querySelectorAll(a)), a = g.makeArray(a)) : void 0
    ...
    }, j._manageStamp = x, j._getElementOffset = function(a) {
        ...
        return c
    }, j.handleEvent = g.handleEvent, j.bindResize = function() {
        ...
        this.resize()
    }, g.debounceMethod(b, "onresize", 100), j.resize = function() {
        ...
        this._emitCompleteOnItems("reveal", a), a && a.length && a.forEach(function(c) {
            c.reveal()
        })
    }, j.hide = function(a) {
        this._emitCompleteOnItems("hide", a), a && a.length && a.forEach(function(c) {
            c.hide()
        })
        ...
        delete v[c], delete this.element.outlayerGUID, m && m.removeData(this.element, this.constructor.namespace)
    }, b.data = function(a) {
        ...
        var a = z(b);
        return a.defaults = g.extend({}, b.defaults), g.extend(a.defaults, d), a.compatOptions = g.extend({}, b.compatOptions), a.namespace = c, a.data = b.data, a.Item = z(f), g.htmlInit(a, c), m && m.bridget && m.bridget(c, a), a
    }, b.Item = f, b
}),
function(a, b) {
    ...
    return a.compatOptions.fitWidth = "isFitWidth", a.prototype._resetLayout = function() {
        ...
        for (var g = this._getColGroup(j), f = Math.min.apply(Math, g), x = g.indexOf(f), q = {
                x: this.columnWidth * x,
                y: f
            }, l = f + w.size.outerHeight, v = this.cols + 1 - g.length, p = 0; v > p; p++) {
            this.colYs[x + p] = l
        }
        return q
        ...
        for (var q = this._getOption("originTop"), l = (q ? g.top : g.bottom) + j.outerHeight, m = p; k >= m; m++) {
                        ...
                        if (Z === "replaceWith") {
                            ...
                            if (Z === "img") {
                                if (ab.is("img")) {
                                    ...
                                    ab.replaceWith(B("<img>").attr("src", ac).attr("class", ab.attr("class")))
                                }
                            } else {
                                ab.attr(V[1], ac)
                            }
            ...
            initGallery: function() {
                ...
                i("BuildControls" + W, function() {
                    if (R.items.length > 1 && V.arrows && !R.arrowLeft) {
                        var Y = V.arrowMarkup,
                            Z = R.arrowLeft = B(Y.replace(/%title%/gi, V.tPrev).replace(/%dir%/gi, "left")).addClass(e),
                            X = R.arrowRight = B(Y.replace(/%title%/gi, V.tNext).replace(/%dir%/gi, "right")).addClass(e);
                        Z.click(function() {
                            R.prev()
                        });
                        X.click(function() {
...
jQuery(function(d) {
    ...
    d("#mainnav a[href*=#]:not([href=#]), a.arrow[href*=#]:not([href=#]), #view-more[href*=#]:not([href=#]), a.sidebar-anchor[href*=#]:not([href=#])").on("click", function() {
...
$(document).ready(function() {
    ...
    $(".grid.worlds-we-love-carousel, .grid.community-carousel").slick({
        infinite: true,
        variableWidth: false,
        slidesToShow: 3,
        slidesToScroll: 3,
...
$(document).ready(function() {
    ...
    $("#watch-video").on("click", function() {
        return document.cookie.indexOf("gt_consent_status=1") < 0 && $("#consentPopup").trigger("click"), !1
    }), $("#watch-video").magnificPopup({
        type: "iframe",
        callbacks: {
            elementParse: function(e) {
                document.cookie.indexOf("gt_consent_status=1") < 0 && evt.preventDefault()
            }
        }
    });
    ...
    $.ajax({
        ...
        success: function(a) {
            if (a.online_user <= 0) {
                $(".server-status").html('<div class="server-down">Server is down for maintenance!</div>')
            } else {
                $(".server-status").html('Server is up |  <span class="counter">' + a.online_user + "</span> Players online!")
            }
            $(".worldofday a").attr("href", a.world_day_images.full_size);
            $(".worldofday img").attr("src", a.world_day_images.resize);
            $(".twitter .tweets").html('<span class="marquee-child">' + a.twitter_tweets + "</span>");
            $("#download-button").html(a.download);
            if (a.shopLink === false) {
                $(".sidebar-list li").each(function(index) {
                    if ($(this).text() === "Shop") $(this).hide();
                });
            }
        },
        error: function(a) {
